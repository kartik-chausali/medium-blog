...
export const Landing = ()=>{
    return <div className="h-screen bg-slate-100">
        ...
        <p className="font-semibold text-lg bg-gradient-to-r from-green-400 to-blue-500  rounded-md text-white">Connect with bloggers around the world and share your voice</p>
        </div>
